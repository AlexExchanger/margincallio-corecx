...
namespace CoreCX
{
    static class App
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Order ord = null;
            Console.WriteLine(core.PlaceLimit(1, "btc", false, 15m, 300m, 12L, 2, ref ord));
            Console.WriteLine(core.PlaceLimit(1, "btc", true, 15m, 310m, 13L, 2, ref ord));
            Console.WriteLine(core.PlaceLimit(1, "ltc", false, 250m, 10m, 16L, 2, ref ord));
            Console.WriteLine(core.PlaceLimit(1, "ltc", true, 250m, 11m, 17L, 2, ref ord));
            Console.WriteLine(core.PlaceMarket(2, "btc", true, false, 6m, 15L, 2, ref ord));
            Console.WriteLine(core.PlaceMarket(2, "btc", false, false, 5m, 14L, 2, ref ord));            
