...
namespace CoreCX.Trading
{
    ...
    class Trade
    {
        ...
        internal Trade(long buy_order_id, long sell_order_id, int buyer_user_id, int seller_user_id, bool side, decimal amount, decimal rate, decimal buyer_fee, decimal seller_fee)
        {
